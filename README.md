# React & Node Project - SpaceX Launch Data 

Welcome to React and Node Project to build a fully-functional SpaceX website.
...
- React, Hooks , Fetch, Express and Node
...
### `serve -s build`  //For static deployment
